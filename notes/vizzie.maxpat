...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 430.0, 145.0, 82.0, 22.0 ],
					"text" : "vz.brcosr",
					"varname" : "vz.brcosr"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "", "", "", "" ],
					"patching_rect" : [ 354.0, 252.0, 206.0, 186.0 ],
					"prototypename" : "pixl",
					"varname" : "attractr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 58.0, 280.0, 177.0, 130.0 ],
					"prototypename" : "pixl",
					"varname" : "sketchr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 101.0, 502.0, 168.0, 108.0 ],
					"prototypename" : "pixl",
					"varname" : "projectr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 37.0, 13.0, 348.0, 158.0 ],
					"prototypename" : "pixl",
					"varname" : "playr",
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-15::obj-71" : [ "pictctrl[5]", "pictctrl[1]", 0 ],
			...
			"obj-20::obj-138" : [ "pictctrl[12]", "pictctrl[1]", 0 ],
			"obj-20::obj-140" : [ "pictctrl[10]", "pictctrl[1]", 0 ],
			"obj-20::obj-142" : [ "pictctrl[13]", "pictctrl[1]", 0 ],
			"obj-20::obj-144" : [ "pictctrl[6]", "pictctrl[1]", 0 ],
			"obj-20::obj-15" : [ "pictctrl[52]", "pictctrl[1]", 0 ],
			"obj-20::obj-28" : [ "Rate", "Rate", 0 ],
			"obj-20::obj-33" : [ "pictctrl[9]", "pictctrl[1]", 0 ],
			"obj-20::obj-7" : [ "textbutton[1]", "textbutton[1]", 0 ],
			"obj-20::obj-8" : [ "pictctrl[8]", "pictctrl[1]", 0 ],
			"obj-20::obj-86" : [ "FreqMode[2]", "FreqMode", 0 ],
			"obj-3::obj-104" : [ "pictctrl[14]", "pictctrl[1]", 0 ],
			"obj-3::obj-119" : [ "Brightness", "Brightness", 0 ],
			"obj-3::obj-120" : [ "Brightness range", "Brightness range", 1 ],
			"obj-3::obj-121" : [ "Offset[2]", "Brightness", 0 ],
			"obj-3::obj-127" : [ "Contrast[1]", "Contrast", 0 ],
			"obj-3::obj-128" : [ "Contrast range", "Contrast range", 1 ],
			"obj-3::obj-129" : [ "contrast", "Contrast", 0 ],
			"obj-3::obj-140" : [ "Saturation", "Saturation", 0 ],
			"obj-3::obj-141" : [ "Saturation range", "Saturation range", 1 ],
			"obj-3::obj-142" : [ "saturation[1]", "Saturation", 0 ],
			"obj-3::obj-147" : [ "pictctrl[44]", "pictctrl[1]", 0 ],
